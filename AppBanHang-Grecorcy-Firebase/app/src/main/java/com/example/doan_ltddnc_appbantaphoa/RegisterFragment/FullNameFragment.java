...
public class FullNameFragment extends Fragment {
    ...
    TextInputEditText edtFirstName , edtLastName ,edtMobile;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        edtMobile =view.findViewById(R.id.edtPhone);
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(firstname.isEmpty() || lastname.isEmpty()){
                    ...
                    navController.navigate(R.id.action_fullnameFragment_to_usernamePasswordFragment,bundle);
                }
            }
        });
    }
